export default {
  ...
  isColor(colorx) {
    let vscolors = ['primary', 'accent', 'secondary', 'info', 'success', 'danger', 'warning', 'dark', 'light']
  ...
  changeColor(colorInicial) {
    let colores = ['primary', 'accent', 'secondary', 'info', 'success', 'danger', 'warning', 'dark', 'light']
    let colorx
