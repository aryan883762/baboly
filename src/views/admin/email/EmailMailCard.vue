<template functional>
  ...
  >
                ...
                <vs-dropdown-menu style="z-index: 40001">
                  <div class="p-2">
                    <p class="text-sm mb-1">
                      From: <span class="font-semibold"> {{ props.mailContent.sender }} </span>
                    </p>
                    <p class="text-sm mb-1">
                      To: <span class="font-semibold"> {{ props.mailContent.to | csv }} </span>
                    </p>
                    <p class="text-sm mb-1">
                      Date: <span class="font-semibold"> {{ props.mailContent.time | time }} {{ props.mailContent.time | date(true) }} </span>
                    </p>
                    <p
                      v-if="props.mailContent.cc.length"
                      class="text-sm mb-1"
                    >
                      cc: <span class="font-semibold"> {{ props.mailContent.cc | csv }} </span>
                    </p>
                  </div>
                </vs-dropdown-menu>
              </vs-dropdown>
    ...
    <!-- MAIL ATTACHMENTS -->
    <div
      v-if="props.mailContent.attachments.length"
      class="vx-row"
    >
      <div
